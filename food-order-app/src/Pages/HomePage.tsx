...
export const HomePage = () => {
    ...
    const [, setAddfood] = useState<Food[]>([]);
    const navigate = useNavigate();
    const [searchParams] = useSearchParams();
  
    function getFoods(): void {
      axios.get("https://be.akshxdevs.com/api/m3/food/").then((res) => {
        setFoods(res.data);
      });
    }
    ...
    function handleAddtoCart(foodImg: string, foodName: string, foodPrice: number) {
      const newFoodItems: Food = { foodImg, foodName, foodPrice, isStockAvailable: true }; 
    ...
    return (
      <div className="flex justify-center">
        <div className="flex flex-col justify-center text-center">
          ...
          <p className="font-medium text-slate-400 pb-5">
            It’s catchy and captures the essence of quick and tasty food delivery!
          </p>
              ...
              >
                ...
                <div className="p-4 md:p-5">
                  ...
                  <button
                    ...
                    onClick={() => handleAddtoCart(food.foodImg, food.foodName, food.foodPrice)}
                  >
                    Add to cart
                  </button>
                </div>
